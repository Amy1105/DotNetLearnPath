...
namespace CSharpBase.CSharpGrammar
{
    /// <summary>
    ///.NET7支持
    /// </summary>
    internal class CSharp11
    {
        ...
        #region 4.UTF-8 字符串字面量

        /// <summary>
        /// UTF-8字符串字面量 , UTF-8字符串字面量有助于在处理UTF-8编码文本时优化内存使用。
        /// </summary>
        ...
        #region 5.字符串内插表达式中的换行符
        /// <summary>
        /// 字符串插值表达式中的换行  此功能允许你在字符串插值块中使用换行符，使复杂的插值更具可读性
        /// 优点：提高复杂字符串插值的可读性。
        /// 缺点：可能会被过度使用，导致代码杂乱。
        ...
        #region   10.Span<char> 上的模式匹配 string
        /// <summary>
        /// 对常量字符串进行Span模式匹配
