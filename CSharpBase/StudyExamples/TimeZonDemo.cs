...
namespace CSharpBase.StudyExamples
{
    public class TimeZonDemo
    {
        ...
        public static bool IsJpEnv()
        {
            ...
            if (TimeZonDemo.Japan.Equals(nation, StringComparison.CurrentCultureIgnoreCase))
            {
                return true;
            }
            return false;
        ...
        {
            var nation = GetNationConfig();
            if (TimeZonDemo.France.Equals(nation, StringComparison.CurrentCultureIgnoreCase))
            {
                return true;
            }
            return false;
        ...
        public static string GetNationFlag()
        {
            ...
            else if (TimeZonDemo.USA.Equals(nation, StringComparison.CurrentCultureIgnoreCase))
            {
                flag = "US";
            }
            else if (TimeZonDemo.Japan.Equals(nation, StringComparison.CurrentCultureIgnoreCase))
            {
                flag = "JP";
            }
            else
