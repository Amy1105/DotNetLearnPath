...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c78bcad3-4a87-4776-854d-6f7f935a2d02
```

> `c78bcad3-4a87-4776-854d-6f7f935a2d02` is the password of the certificate, you can change it to any password you want.
