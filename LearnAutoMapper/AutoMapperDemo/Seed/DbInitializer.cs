    ...
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            foreach (var i in Enumerable.Range(1, 500))
            {
                ...
                var image = new Models.Image() { MainImage = "www.baidu.com" + i.ToString(), Images = new List<string>() { "www.baidu.com1", "www.baidu.com2", "www.baidu.com3" } };
